...
function verifyPassword() {
  const password = prompt("Enter Password to continue deletion:");
...
const message = document.getElementById("message");    document.getElementById("photo").addEventListener("change", function () {
...
row.querySelectorAll(".name, .contact, .description, .status, .estimate")  .forEach(td => td.contentEditable = "false");
